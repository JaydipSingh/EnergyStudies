...
namespace example {
  ...
  class JDprotoDUNESpacePointAna : public art::EDAnalyzer
  {
  public:
    ...
    explicit JDprotoDUNESpacePointAna(Parameters const& config);
 ...
 art::InputTag fClusterProducerLabel;    ///< The name of the producer that created clusters
  ...
  //
 JDprotoDUNESpacePointAna::JDprotoDUNESpacePointAna(Parameters const& config)
    : EDAnalyzer(config)
  ...
  //-----------------------------------------------------------------------
  void JDprotoDUNESpacePointAna::beginJob()
  {
  ...
  void JDprotoDUNESpacePointAna::beginRun(const art::Run& /*run*/)
  {
 ...
 void JDprotoDUNESpacePointAna::analyze(const art::Event& event)
  {
...
double  MCTrackExitZpospx=positionEnd.Z() + tpx; double  MCTrackExitZpospy=positionEnd.Z() + tpy; double MCTrackExitYpospz=positionEnd.Y()+tpz;
  ...
  DEFINE_ART_MODULE(JDprotoDUNESpacePointAna)
